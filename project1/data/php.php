<?php
	...
	// https://api.weatherapi.com/v1/forecast.json?q=London&key=<api_key>&days=4&aqi=no
  ...
  header('Access-Control-Allow-Origin: *');	
	...
	$url='https://api.weatherapi.com/v1/forecast.json?q=' . $_REQUEST['location'] . '&key=<api_key>=5&aqi=no';
